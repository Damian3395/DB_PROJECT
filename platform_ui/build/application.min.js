...
var Window = React.createClass({displayName: "Window",
    ...
    render: function(){
        return (
            React.createElement("div", null, 
                React.createElement(NavBar, {stateCallback: this.setState}), 
                React.createElement(Page, {state: this.state.state})
            )
        );
    }
});
...
},{"./NavBar.jsx":162,"./Page.jsx":163,"react":156}],159:[function(require,module,exports){
var React = require('react');
...
var BusinessLogin = React.createClass({displayName: "BusinessLogin",
    render: function(){
        return(
            React.createElement("div", null, 
                React.createElement("p", null, "Business Login Page")
            )
        );
    }
});
                    ...
                    React.createElement("div", {className: "container-fluid"}, 
                        ...
                        React.createElement("div", {className: "navbar-collapse collapse"}, 
                            React.createElement("form", {className: "navbar-form navbar-left"}, 
                                React.createElement("button", {className: "btn btn-default", onClick: this.setPageState.bind(this, "Home")}, "RUExploring"), 
                                React.createElement("button", {className: "btn btn-default", onClick: this.setPageState.bind(this, "About")}, "About"), 
                                React.createElement("button", {className: "btn btn-default", onClick: this.setPageState.bind(this, "Contact")}, "Contact")
                            ), 
                            React.createElement("form", {className: "navbar-form navbar-right"}, 
                                React.createElement("button", {className: "btn btn-default", onClick: this.setPageState.bind(this, "User_Login")}, "User Login"), 
                                React.createElement("button", {className: "btn btn-default", onClick: this.setPageState.bind(this, "Business_Login")}, "Business Login")
                            )
                        )
                    )
                )
    ...
    render: function(){
        ...
        switch(this.props.state){
            ...
            case "User_Login":
                ...
                Body = React.createElement(UserLogin, null)
                break;
            case "Business_Login":
                console.log("Set Body Business Login Page");
                Body = React.createElement(BusinessLogin, null)
                break;
            default:
                Body = React.createElement(Home, null)
...
},{"./About.jsx":157,"./BusinessLogin.jsx":159,"./Contact.jsx":160,"./Home.jsx":161,"./UserLogin.jsx":164,"react":156}],164:[function(require,module,exports){
var React = require('react');
...
var UserLogin = React.createClass({displayName: "UserLogin",
    render: function(){
        return(
            React.createElement("div", null, 
                React.createElement("p", null, "User Login Page")
            )
        )
    }
});
