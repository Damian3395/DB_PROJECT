				...
				<div className="col-md-12">
					<div className="panel panel-success">
						...
						<div className="panel-body">
								...
								<div className="row">
									<div className="col-xs-4">
										<span className="label label-info">{this.props.address}</span>
									</div>
									<div className="col-xs-4">
										<span className="label label-info">{this.props.township}</span>
									</div>
									<div className="col-xs-4">
										<span className="label label-info">{this.props.campus}</span>
									</div>
								</div>
						</div>
					</div>
